...
const string strMessageMagic = "BinCoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BinCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "BinCoin Genesis Block";
        CTransaction txNew;
        if (!fTestNet)
        {
        ...
        // debug print
        assert(block.hashMerkleRoot == uint256("0x955c5d074082969b00413b054e3366b84ada50cb25820215d2364034d701dc56"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x42, 0x05, 0xe4, 0xe3 };
